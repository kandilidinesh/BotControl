...
public class HarshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1=(Switch) findViewById(R.id.harshac);
        s2=(Switch)  findViewById(R.id.harshlight);
        ...
        final MqttAndroidClient client =
                new MqttAndroidClient(HarshActivity.this, "tcp://172.16.73.4:1883", clientId);
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    // We are connected
                    //Toast.makeText(HarshActivity.this,"Device List",Toast.LENGTH_SHORT).show();
                    ...
                    s1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (s1.isChecked())
                            {
                                payload = "harsh/fan/on";
                            }
                            if (!s1.isChecked())
                            {
                                payload = "harsh/fan/off";
                            }
                    ...
                    s2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (s2.isChecked())
                            {
                                payload = "harsh/light/on";
                            }
                            if (!s2.isChecked())
                            {
                                payload = "harsh/light/off";
                            }
                            byte[] encodedPayload = new byte[0];
                            try {
                                encodedPayload = payload.getBytes("UTF-8");
                ...
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    ...
                    Toast.makeText(HarshActivity.this,"Restart the application",Toast.LENGTH_SHORT).show();
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Switch fan = (Switch) findViewById(R.id.harshac);
        Switch light = (Switch) findViewById(R.id.harshlight);
